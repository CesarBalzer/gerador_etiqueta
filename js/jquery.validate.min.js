...
messages:{
            required: "Campo obrigatório, verifique!.",
            remote: "Please fix this field.",
            email: "O email não é válido, verifique!.",
            url: "Please enter a valid URL.",
            date: "A data não é válida, verifique!.",
            dateBR: "A data não é válida, verifique!.",
            dateISO: "Please enter a valid date (ISO).",
            number: "O campo só aceita números, verifique!.",
            digits: "O campo só aceita caracteres válidos.",
            creditcard: "Please enter a valid credit card number.",
            equalTo: "Please enter the same value again.",
            accept: "Please enter a value with a valid extension.",
            maxlength: $.validator.format("Máximo de {0} caracteres, verifique!."),
            minlength: $.validator.format("Mínimo de {0} caracteres, verifique!."),
